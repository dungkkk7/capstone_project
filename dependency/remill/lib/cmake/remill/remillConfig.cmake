...
foreach(_comp ${remill_FIND_COMPONENTS})
  ...
  if ("VCPKG_DEPS" STREQUAL _comp)
    ...
    if(NOT "x/home/dungbv/WorkSpace/lifter/third_party/lifting-bits-downloads/vcpkg_ubuntu-20.04_llvm-11_amd64x" STREQUAL "xx" AND NOT USE_SYSTEM_DEPENDENCIES)
      if (EXISTS "/home/dungbv/WorkSpace/lifter/third_party/lifting-bits-downloads/vcpkg_ubuntu-20.04_llvm-11_amd64")
        set(VCPKG_ROOT "/home/dungbv/WorkSpace/lifter/third_party/lifting-bits-downloads/vcpkg_ubuntu-20.04_llvm-11_amd64"
