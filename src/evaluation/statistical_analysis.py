...
CONTRASTS = (
    ("F1_VS_F2_CLEAN_IR_VS_RAW_IR", "F1", "F2"),
    ("F1_VS_F3_ITERATIVE_VS_ONESHOT", "F1", "F3"),
    ("B1_VS_B2_BASELINE_REPRESENTATIONS", "B1", "B2"),
    ("F1_VS_B1_CLEAN_IR_VS_GHIDRA_MULTIFACTOR", "F1", "B1"),
    ("F1_VS_B2_CLEAN_IR_VS_ASSEMBLY_MULTIFACTOR", "F1", "B2"),
)
