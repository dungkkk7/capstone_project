...
; CHECK: call ptr @sub_1200(
; CHECK-SAME: i64 4688
; CHECK-NOT: __lifter_refine_dispatch_sub_1200
...
@data_1250 = internal global i8 0
...
inst_1000:
  ...
  %ret = call i64 %callee(i64 ptrtoint (ptr @data_1250 to i64), i64 1, i64 2, i64 0, i64 0, i64 0, i64 0, i64 0)
  ret ptr %memory
}
