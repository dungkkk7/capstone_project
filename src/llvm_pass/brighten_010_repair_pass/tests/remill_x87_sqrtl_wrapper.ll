...
; CHECK: [[SP:%[0-9]+]] = load i64, ptr {{@RSP_0_i|@__mcsema_reg_state}}{{.*}}
...
; CHECK: store x86_fp80 [[RES]], ptr {{.*}}, align 1
; CHECK: store i64 [[AFTER]], ptr {{@RSP_0_i|@__mcsema_reg_state}}{{.*}}
; CHECK-NOT: load i64, ptr {{@ST7_0_i|getelementptr.*@__mcsema_reg_state}}
; CHECK-NOT: store i64 {{.*}}, ptr {{@RAX_0_i|getelementptr.*@__mcsema_reg_state}}
