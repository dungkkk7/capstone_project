; The current commit path treats direct alloca GEPs as the stack base; a
; non-zero direct GEP must be refused rather than dropping its displacement.
; CHECK-NOT: @frame_storage_backing.main
; CHECK: %native_stack = alloca [1048576 x i8]
; CHECK: %slot = getelementptr inbounds [1048576 x i8], ptr %native_stack, i64 0, i64 64
